const paths = {
  ...
  twitter: (
    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C4 15.7 2.4 9.7 5 5c2.3 2.9 5.6 4.6 9 5-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2s-.4 2.5-2.4 3.6C22.5 8 23 7 23 7s-.5 2.4-2 4c1.6-.1 3.3-1.4 3.3-1.4" />
  ),
}
